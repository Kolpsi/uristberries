...
function createCircle(circle,circleText,deg){document.querySelector(circle).innerHTML=circleText.split('').map((e,i)=>`<span class="circle-span" style="--rot:${i*deg}deg">${e}</span>`).join('');}
